...
console.log("Hello I am putting an answer!");
/**
...
console.log(
  "Step 1:  Number of Available Seats on this Plane + AvailPlaneSeats"
);
let AvailPlaneSeats = 21;

console.log("Step 2:  Cost of Groceries");
let costOfGroceries = 275.75;
...
let streetAddress = "123 Easy Street";
...
console.log("Total cost of groceries: " + costOfGroceries);

console.log(
  "Fix a Birth Certificate: " + " new middle intitial " + middleInitial
);
//	A birth certificate was printed incorrectly, change the middle initial to something else
//  ↓ YOUR CODE HERE ↓
middleInitial = "F";

console.log("Changing Seasons: is it hot outside? " + isHotOutside);
...
let fullName = firstName + middleInitial + "Doe";
...
let greet = "Hello " + fullName + " from " + streetAddress;
console.log(greet);
